...
1. [Introduction of MiMut](https://github.com/qslin/MiMut/blob/main/README.md#Introduction)
2. [The primary principle of MiMut](https://www.example.com)
3. [The secondary workflow of MiMut using SL9 and LF10 inbred lines](https://www.example.com)
...
## The secondary workflow of MiMut using SL9 and LF10 inbred lines
